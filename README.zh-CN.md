...
- `CLAUDE.md` - repository agent harness 和工作规则
- `docs/README.md` - 文档地图
- `docs/product-requirements.md` - 产品范围和用户流程
- `docs/architecture.md` - app、bridge、ACP 和数据模型架构
- `docs/android-app.md` - Android app 配对、MVP 能力和验证
- `docs/acp-bridge-contract.md` - Android 到 bridge 的 API contract
- `docs/machine-pairing.md` - Tailscale 检测和 QR 配对
- `docs/security-model.md` - 权限、Approval 和 threat model
- `docs/harness-engineering.md` - harness layers 和 enforcement plan
